...
public final class RingBuffer<T> {
    ...
    {
        RingBuffer<Integer> rbuf = new RingBuffer<Integer>(4);
        try
        {
            rbuf.add(new Integer(1));
            rbuf.add(new Integer(2));
            rbuf.add(new Integer(3));
            System.out.println("Removing: " + rbuf.remove());
            rbuf.add(new Integer(4));
            System.out.println("Removing: " + rbuf.peek());
        }
