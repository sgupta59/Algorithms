package threading.SingleLaneBridge;
import java.awt.*;
import java.util.*;
import javax.swing.*;
...
class CarWorld extends JPanel {
    ...
    public CarWorld() {
        ...
        redCar = toolkit.getImage("C:\\Users\\kg\\git\\Algorithms\\scratch\\src\\threading\\SingleLaneBridge\\image\\redcar.gif");
        mt.addImage(redCar, 0);
        blueCar = toolkit.getImage("C:\\Users\\kg\\git\\Algorithms\\scratch\\src\\threading\\SingleLaneBridge\\image\\bluecar.gif");
        mt.addImage(blueCar, 1);
        bridge = toolkit.getImage("C:\\Users\\kg\\git\\Algorithms\\scratch\\src\\threading\\SingleLaneBridge\\image\\bridge1.gif");
